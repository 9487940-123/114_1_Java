public class Magician extends Role{
    ...
    public  void showSpecialSkill(){
        System.out.println(this.getName()+"使用了魔法師的特特殊技能");
        System.out.println("┌─────────────────────────────┐");
        System.out.println("│ 魔法師 的特殊技能          │");
        System.out.println("├─────────────────────────────┤");
        System.out.println("│ 技能名稱：強力治癒          │");
        System.out.println("│ 技能描述：使用強力魔法治療  │");
        System.out.println("│ 技能效果：回復 " + healPower + " 點生命值 │");
        System.out.println("└─────────────────────────────┘");
    };
}